...
class MobileShellTests(unittest.TestCase):
    ...
    def test_module_panel_bridge_is_central_and_idempotent(self):
        ...
        self.assertIn('body{background:#101114!important}', injected)
        self.assertIn('body{background:#11141c!important}', injected)
        self.assertIn('body{background:#000!important}', injected)
        self.assertIn('--bg:#101114!important;--panel:#101114!important', injected)
        self.assertIn('--bg:#11141c!important;--panel:#11141c!important', injected)
        self.assertIn('--bg:#000!important;--panel:#000!important', injected)
