...
Для Senler можно отправлять `context: 4`: endpoint вернет ответ по краткой сводке о клиенте, сохранит вопрос/ответ и обновит сводку в фоне, не удерживая webhook ожиданием полной истории.
