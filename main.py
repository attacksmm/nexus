...
:root[data-nexus-theme="dark"]{color-scheme:dark;filter:none;background:#101114!important;--bg:#101114!important;--panel:#101114!important}
:root[data-nexus-theme="dark"] body{background:#101114!important}
:root[data-nexus-theme="gray"]{color-scheme:dark;filter:invert(.18);background:#11141c!important;--bg:#11141c!important;--panel:#11141c!important}
:root[data-nexus-theme="gray"] body{background:#11141c!important}
:root[data-nexus-theme="gray"] img,:root[data-nexus-theme="gray"] video,:root[data-nexus-theme="gray"] canvas{filter:invert(1)}
:root[data-nexus-theme="light"]{color-scheme:dark;filter:invert(1) hue-rotate(180deg);background:#000!important;--bg:#000!important;--panel:#000!important}
:root[data-nexus-theme="light"] body{background:#000!important}
