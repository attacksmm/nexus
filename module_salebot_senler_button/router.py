...
def _snippet(*, base_url: str, button_id: str, group_id: str, subscription_id: str, button_text: str, target_selector: str, redirect_url: str) -> str:
    ...
    return (
        ...
        'function css(){if(document.getElementById("nexus-salebot-senler-inline-style"))return;var s=document.createElement("style");s.id="nexus-salebot-senler-inline-style";s.textContent=".nexus-salebot-senler-source{position:absolute!important;left:-10000px!important;top:auto!important;width:1px!important;height:1px!important;overflow:hidden!important;opacity:0!important;pointer-events:none!important}.nexus-salebot-senler-pending-vk{visibility:hidden!important}.nexus-salebot-senler-btn.senler-btn,.nexus-salebot-senler-btn.senler-btn-alt{display:flex!important;align-items:center!important;justify-content:center!important;gap:8px!important;width:var(--nexus-senler-width,auto)!important;max-width:100%!important;min-height:var(--nexus-senler-height,44px)!important;padding:0 18px!important;box-sizing:border-box!important;border-radius:999px!important;border:0!important;background:#4b86c9!important;color:#fff!important;font-family:inherit!important;font-size:inherit!important;line-height:1.15!important;font-weight:700!important;text-align:center!important;text-decoration:none!important;cursor:pointer!important;box-shadow:none!important;white-space:normal!important;letter-spacing:0!important;margin:0 auto!important}.nexus-salebot-senler-btn.senler-btn:before,.nexus-salebot-senler-btn.senler-btn-alt:before{content:\\"VK\\";display:inline-flex!important;align-items:center!important;justify-content:center!important;font-size:.9em!important;font-weight:900!important;line-height:1!important;color:#fff!important;font-family:Arial,Helvetica,sans-serif!important}";(document.head||document.documentElement).appendChild(s)}'
        ...
        'function fit(n,a){var r=a.getBoundingClientRect(),cs=getComputedStyle(a);if(r.width>80)n.style.setProperty("--nexus-senler-width",Math.round(r.width)+"px");if(r.height>30)n.style.setProperty("--nexus-senler-height",Math.round(r.height)+"px");if(cs.fontSize)n.style.fontSize=cs.fontSize}'
        'function mount(vk,i){if(vk.getAttribute("data-nexus-salebot-senler-bound"))return;vk.setAttribute("data-nexus-salebot-senler-bound","1");vk.classList.add("nexus-salebot-senler-pending-vk");var id=cfg.buttonId+"-"+(i+1),n=document.getElementById(id)||document.createElement("div");n.id=id;n.classList.add("nexus-salebot-senler-btn");n.setAttribute("data-nexus-salebot-senler","1");n.setAttribute("data-vk_group_id",cfg.groupId||(source&&source.getAttribute("data-vk_group_id"))||"");n.setAttribute("data-subscription_id",cfg.subscriptionId||(source&&source.getAttribute("data-subscription_id"))||"");n.setAttribute("data-text",cfg.text);n.setAttribute("data-alt_text","");vk.parentNode.insertBefore(n,vk.nextSibling);fit(n,vk);load(function(){try{if(!n.classList.contains("senler-btn"))Senler.ButtonSubscribe(id)}catch(e){console.log(e)}n.classList.add("nexus-salebot-senler-btn");if(n.textContent.trim()!==cfg.text)n.textContent=cfg.text;fit(n,vk);bindRedirect(n);setTimeout(function(){vk.style.display="none";vk.classList.remove("nexus-salebot-senler-pending-vk")},250)})}'
...
(function(){{
  ...
  function ensureStyle(){{
    ...
    s.textContent='.nexus-vk-direct-btn{{display:flex!important;align-items:center!important;justify-content:center!important;gap:8px!important;width:var(--nexus-vk-direct-width,100%)!important;max-width:100%!important;min-height:var(--nexus-vk-direct-height,44px)!important;padding:0 18px!important;box-sizing:border-box!important;border-radius:999px!important;background:#4b86c9!important;color:#fff!important;font-family:inherit!important;font-size:inherit!important;line-height:1.15!important;font-weight:700!important;text-align:center!important;text-decoration:none!important;margin:0!important;letter-spacing:0!important}}.nexus-vk-direct-btn:before{{content:"VK";font:900 .9em/1 Arial,Helvetica,sans-serif;color:#fff}}.nexus-vk-direct-senler-fallback.senler-btn,.nexus-vk-direct-senler-fallback.senler-btn-alt{{display:flex!important;align-items:center!important;justify-content:center!important;gap:8px!important;width:var(--nexus-vk-direct-width,100%)!important;max-width:100%!important;min-height:var(--nexus-vk-direct-height,44px)!important;padding:0 18px!important;box-sizing:border-box!important;border-radius:999px!important;background:#4b86c9!important;color:#fff!important;font-family:inherit!important;font-size:inherit!important;line-height:1.15!important;font-weight:700!important;text-align:center!important;text-decoration:none!important;margin:0!important;letter-spacing:0!important}}.nexus-vk-direct-pending-vk{{visibility:hidden!important}}@media(max-width:640px){{.nexus-vk-direct-btn,.nexus-vk-direct-senler-fallback.senler-btn,.nexus-vk-direct-senler-fallback.senler-btn-alt{{min-height:42px!important;padding:0 14px!important}}}}';
  ...
  function fit(link,vk){{
    ...
    var r=anchor.getBoundingClientRect(),cs=getComputedStyle(anchor);
    if(r.width>80){{
      link.style.setProperty('--nexus-vk-direct-width',Math.round(r.width)+'px');
      link.style.setProperty('width',Math.round(r.width)+'px','important');
    }}
    if(r.height>30){{
      link.style.setProperty('--nexus-vk-direct-height',Math.round(r.height)+'px');
      link.style.setProperty('min-height',Math.round(r.height)+'px','important');
    }}
...
(function() {{
  ...
  function ensureStyles() {{
    ...
    style.textContent = [
      ...
      'width:var(--nexus-senler-width,auto)!important;max-width:100%!important;',
      'min-height:var(--nexus-senler-height,44px)!important;padding:0 18px!important;',
      ...
      'text-align:center!important;text-decoration:none!important;cursor:pointer!important;',
      'box-shadow:none!important;white-space:normal!important;letter-spacing:0!important;margin:0 auto!important;',
      '}}',
      ...
      'font-family:Arial,Helvetica,sans-serif!important;letter-spacing:-.03em!important;',
      '}}',
      '@media (max-width:640px){{.nexus-salebot-senler-btn.senler-btn,.nexus-salebot-senler-btn.senler-btn-alt{{min-height:42px!important;padding:0 14px!important;}}}}'
    ].join('');
  ...
  function fitToAnchor(node, anchor) {{
    ...
    if (rect.width > 80) {{
      node.style.setProperty('--nexus-senler-width', Math.round(rect.width) + 'px');
    }}
    if (rect.height > 30) node.style.setProperty('--nexus-senler-height', Math.round(rect.height) + 'px');
    ...
    if (parent) {{
      ...
      if ((cs.display || '').indexOf('flex') !== -1) {{
        ...
        parent.style.alignItems = cs.alignItems && cs.alignItems !== 'normal' ? cs.alignItems : 'center';
